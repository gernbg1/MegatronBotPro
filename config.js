...
global.owner = [
['51918425805', 'Yallico Owner 🤖', true],
['528451091586', 'Megatron Bot Ofc 🤖', true],
[''],
[''],
[''],
['']]

global.suittag = ['51918425805']
global.prems = []
global.mods = []

//• ↳ ◜𝑴𝑨𝑹𝑪𝑨𝑺 𝑫𝑬 𝑨𝑮𝑼𝑨◞ • 💌
global.packname = '𝗠𝗲𝗴𝗮𝘁𝗿𝗼𝗻 𝗕𝗼𝘁 𝗣𝗿𝗼'
global.author = '@yallico.owner'
global.wm = '𝗠𝗲𝗴𝗮𝘁𝗿𝗼𝗻 𝗣𝗿𝗼'
global.titulowm = '𝗠𝗲𝗴𝗮𝘁𝗿𝗼𝗻 𝗕𝗼𝘁 𝗣𝗿𝗼 🤖'
global.titulowm2 = ''
global.igfg = '@yallico.owner'
global.botname = '𝗠𝗲𝗴𝗮𝘁𝗿𝗼𝗻 𝗕𝗼𝘁 🤖'
global.dev = '`𝗠𝗲𝗴𝗮𝘁𝗿𝗼𝗻 𝗕𝗼𝘁 🤖`\n*By • Yallico 🇵🇪*'
global.textbot = '𝗠𝗲𝗴𝗮𝘁𝗿𝗼𝗻 𝗕𝗼𝘁 🤖'
global.vs = '2.0'
...
//• ↳ ◜𝑭𝑨𝑲𝑬 𝑬𝑺𝑻𝑰𝑳𝑶◞ • 🪩
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '𝗠𝗲𝗴𝗮𝘁𝗿𝗼𝗻 𝗕𝗼𝘁-𝗠𝗗', orderTitle: 'packname', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net'}}}

global.fakegif2 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'MegatronBotPro', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '⚘݄𖠵⃕⁖𖥔.𝐁𝐢𝐞𝐧𝐯𝐞𝐧𝐢𝐝𝐨❞ ꔷ──᜔◇⃟̣̣⃕✨', jpegThumbnail: catalogo }}};

global.fakegif3 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'MegatronBotPro', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '𝗠𝗲𝗴𝗮𝘁𝗿𝗼𝗻 𝗕𝗼𝘁 𝗣𝗿𝗼', jpegThumbnail: catalogo }}};

global.fakegif4 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'MegatronBotPro', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '⚘݄𖠵⃕⁖𝐒𝐭𝐢𝐜𝐤𝐞𝐫 (^_^♪) 💥', jpegThumbnail: catalogo }}};

global.estilox = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '𝗠𝗲𝗴𝗮𝘁𝗿𝗼𝗻 𝗕𝗼𝘁 𝗣𝗿𝗼', orderTitle: 'packname', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net'}}}
...
global.bgp = 'https://chat.whatsapp.com/FyxDHzo3BpE20gyWVJdDHn' //GRUPO DE AVISOS
global.bgp2 = 'https://chat.whatsapp.com/FyxDHzo3BpE20gyWVJdDHn' //GRUPO GLOBAL 1
global.bgp3 = 'https://chat.whatsapp.com/FyxDHzo3BpE20gyWVJdDHn' //GRUPO GLOBAL 2
global.bgp4 = 'https://chat.whatsapp.com/FyxDHzo3BpE20gyWVJdDHn' //GRUPO NSFW
