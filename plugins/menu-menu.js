...
const defaultMenu = {
  before: `“𝐇𝐨𝐥𝐚 *%name* 𝐒𝐨𝐲 𝐌𝐞𝐠𝐚𝐭𝐫𝐨𝐧 𝐁𝐨𝐭 𝐏𝐫𝐨, %greeting"
...
const pp = await conn.profilePictureUrl(who, 'image').catch(_ => 'https://qu.ax/YxZp.mp4')
