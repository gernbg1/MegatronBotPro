...
global.authFile = `MegaSession`
global.authFileJB = `MegaJadiBot`
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Mega-Bot', 'Edge', '2.0.0'] : methodCodeQR ? ['Mega-Bot', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
const subBotDirectory = './MegaJadiBot';
if (!existsSync(subBotDirectory)) {
console.log('🌟 MegaBot-MD no tiene Sub-Bots vinculados.');
return;
}
...
const mainBotAuthFile = 'MegaSession';
try {
const mainBot = await connectionUpdate(mainBotAuthFile);
global.conns.push(mainBot);
console.log(chalk.bold.greenBright(`⭐ MegaBot-MD conectado correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(`⭐ Error al iniciar Mega-Bot: `, error))
}
})();*/
